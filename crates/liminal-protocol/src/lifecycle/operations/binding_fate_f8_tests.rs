...
/// the bug.
#[test]
#[ignore = "TEMPORARY observation scaffolding, reverted in the next commit: the ruled \
            fail-fast tier-1 string cannot reach the server test binary while this red lives"]
